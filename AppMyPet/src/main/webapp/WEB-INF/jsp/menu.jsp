...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">AppMyPet</a>
    </div>
    <ul class="nav navbar-nav">
	  ...
	  <c:if test="${not empty user}">
	      ...
	      <li class="nav-item">
	        <a class="nav-link" href="/consulta/lista">Consulta</a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link" href="/medicamento/lista">Medicamento</a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link" href="/vacina/lista">Vacina</a>
	      </li>
      </c:if>
    </ul>
